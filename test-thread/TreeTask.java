...
public class TreeTask {
    ...
    private static final int PERMUTE_NODES = INITIAL_NODES / 20;

    private static final TreeTask taskInstance;

    static {
        taskInstance = new TreeTask();
        taskInstance.build();
    }
